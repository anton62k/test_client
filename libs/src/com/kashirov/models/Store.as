package com.kashirov.models 
{
	...
	public class Store extends Proxy implements IModel
	{
		...
		public function getOrAddItem(key:* = null, data:Object = null, dispatch:Boolean = true):IModel {
			var item:IModel;
			if (getItem(key)) {
				item = getItem(key);
				item.updateData(data);
			} else {
				item = addItem(key, data, dispatch);
			}
			return item;
		}
		...
		public function setNextId(value:int):void {
			this.nextId = value;
		}
